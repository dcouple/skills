...
4. Use an independent researcher for substantial parallel research when helpful, passing evidence and scope.
...
- If connected, keep research, drafts, and the outreach record in the supplied task folder, or `Development Artifacts/YYYY-MM-DD-<task>`; pass its ID and rule to researchers and sync outputs.
