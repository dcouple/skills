# Opponent round - format

Print exactly the structure for **your round type** as your final message (it
is appended verbatim to the motion file). The dispatch names the round; match it.

## Round 1 (blind opening - no advocate text yet)

You have only the motion. State your opening position; there is nothing to
rebut, so do not invent a rebuttal.
...
The last round always carries the steelman and blind-spot lines the verdict
depends on.
...
**Blind spot:** <what neither position has addressed.>
