...
description: Orchestrate RunPane issue-to-PR workstreams across discussion, plan, implementation, review, PR testing, and CLI dogfooding without stealing user focus.
argument-hint: "[repo, issue URLs/numbers, or orchestration goal]"
---
