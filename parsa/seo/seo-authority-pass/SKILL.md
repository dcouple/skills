...
- **Writing process**: Follow `seo-writing-framework` when writing explainer pages and copy. Research examples, draft with reference, reader hat, edit, run the `no-ai-slop` gate, score.
