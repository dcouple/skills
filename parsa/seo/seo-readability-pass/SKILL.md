...
- **Writing process**: Follow `seo-writing-framework` when rewriting pages. Research examples, draft with reference, reader hat, edit, run the `no-ai-slop` gate, score.
